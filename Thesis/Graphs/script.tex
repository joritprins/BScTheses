...
%Shape: Rectangle [id:dp25340424131220984] 
\draw  [color={rgb, 255:red, 255; green, 0; blue, 0 }  ,draw opacity=1 ] (68,71) -- (155,71) -- (155,281) -- (68,281) -- cycle ;
%Shape: Rectangle [id:dp25340424131220984] 
\draw  [color={rgb, 255:red, 0; green, 255; blue, 0 }  ,draw opacity=1 ] (160,50) -- (354,50) -- (354,281) -- (160,281) -- cycle ;
%Shape: Rectangle [id:dp25340424131220981] 
\draw  [color={rgb, 255:red, 0; green, 0; blue, 255 }  ,draw opacity=1 ] (357,71) -- (545,71) -- (545,281) -- (357,281) -- cycle ;
%Shape: Rectangle [id:dp25340424131220981] 
\draw  [color={rgb, 255:red, 255; green, 0; blue, 0 }  ,draw opacity=1 ] (550,71) -- (600,71) -- (600,281) -- (550,281) -- cycle ;

% Text Node
\draw (176,83) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\footnotesize Launch Scaphandre}};
% Text Node
\draw (171,110.4) node [anchor=north west][inner sep=0.75pt]   [align=left] {\begin{minipage}[lt]{81.6pt}\setlength\topsep{0pt}
\begin{center}
{\footnotesize Launch run-server.sh }\\{\footnotesize and/or run-client.sh}
\end{center}
...
% Text Node
\draw (170,50) node [anchor=north west][inner sep=0.75pt]   [align=left] {\verb|run_test_[experiment].sh|};
% Text Node
\draw (355,82.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {\verb|run-server.sh/run-client.sh|};
% Text Node
\draw (554,105) node [anchor=north west][inner sep=0.75pt]   [align=left] {SNNI};
% Text Node
\draw (389,171.4) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\footnotesize Wait for SNNI to finish}};
% Text Node
...
% Text Node
\draw (170,250.4) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\footnotesize Process measurements}};
% Text Node
\draw (68,70) node [anchor=north west][inner sep=0.75pt]   [align=left] {\verb|./scaphandre|};
% Text Node
