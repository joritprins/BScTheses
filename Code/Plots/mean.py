...
xcr, cheetah_resnet50_client, cheetah_resnet50_server = plot('Code/Plots/Results/same-device/cheetah-resnet50-50', 'cheetah-resnet50', runs=50, end=256)
xcs, cheetah_sqnet_client, cheetah_sqnet_server = plot('Code/Plots/Results/same-device/cheetah-sqnet-50', 'cheetah-sqnet', runs=50, end=53)
xss, SCI_HE_sqnet_client, SCI_HE_sqnet_server = plot('Code/Plots/Results/same-device/SCI_HE-sqnet-50', 'SCI_HE-sqnet', runs=50, end=82)
xsr, SCI_HE_resnet50_client, SCI_HE_resnet50_server = plot('Code/Plots/Results/same-device/SCI_HE-resnet50-50', 'SCI_HE-resnet50', runs=50, end=560)
